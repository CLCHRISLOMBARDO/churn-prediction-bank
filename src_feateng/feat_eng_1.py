...
from src.constr_lista_cols import contruccion_cols,cols_a_dropear_variable_entera,cols_a_dropear_variable_por_feat ,cols_a_dropear_variable_originales_o_percentiles,cols_a_dropear_variable_originales_o_corregidas
from src.feature_engineering import copia_tabla,feature_engineering_correccion_variables_por_mes_por_media,feature_engineering_percentil,feature_engineering_lag,feature_engineering_delta,feature_engineering_max_min,feature_engineering_ratio,feature_engineering_linreg,feature_engineering_drop_cols,feature_engineering_drop_meses
...
def lanzar_feat_eng(fecha:str ,n_fe:int , proceso_ppal:str):
    ...
    df_completo_chiquito=creacion_df_small("df_completo")
    _,  cols_lag_delta_max_min_regl  ,   cols_ratios = contruccion_cols(df_completo_chiquito)
