...
from src.feature_engineering import feature_engineering_lag_orden_fijo,feature_engineering_delta_orden_fijo,feature_engineering_mean,feature_engineering_mes,feature_engineering_ctrx_norm,feature_engineering_mpayroll_sobre_edad,conversion_parquet,copia_tabla,feature_engineering_correccion_variables_por_mes_por_media,suma_de_prod_servs,suma_ganancias_gastos,ratios_ganancia_gastos,feature_engineering_percentil,feature_engineering_lag,feature_engineering_delta,feature_engineering_max_min,feature_engineering_ratio,feature_engineering_linreg,feature_engineering_drop_cols,feature_engineering_drop_meses
...
def lanzar_feat_eng(fecha:str ,n_fe:int , proceso_ppal:str):
    ...
    feature_engineering_lag_orden_fijo(df_completo_chiquito,cols_lag_delta_max_min_regl,6)
